...
<ul>
	...
	<p>I built a front end for this data using the Google Maps API and some JS plugins. The data doesn't reveal anything that makes me uncomfortable, so I made it available <a href="location_history">here</a>.</p></li>
</ul>
